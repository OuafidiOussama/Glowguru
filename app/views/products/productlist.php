         ...
         <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Store Mng</h2>
                </div>
            ...
            <div class="row my-5">
                    <h3 class="fs-4 mb-3">Product Manager</h3>
                    <div class="add-product mb-3"><a href="<?= URLROOT;?>/products/addForm"><button class="btn btn-primary">ADD PRODUCT</button></a></div>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <?php foreach($data['product'] as $products) : ?>
                                <tr>
                                    <td class="img-cnt text-center"><img src="<?php echo URLROOT. '/prd_images/' . $products->picture ; ?>" alt="image"></td>
                                    <td class="text-center"><?php echo $products->title?></td>
                                    <td class="text-center">$<?php echo $products->price?></td>
                                    <td class="text-center">
                                        <a href="<?= URLROOT . '/Products/edit/' . $products->id ?>"><button type="button" class="btn btn-primary">Update</button></a>
                                        <a href="<?= URLROOT . '/Products/delete/' . $products->id ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
